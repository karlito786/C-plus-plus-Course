...
int main(){
  ...
  // std::flush : flushes the output bugger to its final destination.
  ...
  // right justified
  std::cout << std::endl;
  std::cout << "Right justified tale(default) : " << std::endl;
  ...
  // boolalpha and noboolalpha : control bool output format : 1/10 or true/false 
  ...
  std::cout << "condition : " << condition << std::endl;
  std::cout << "other_conditon : " << other_condition << std::endl;
  ...
  // showpoint and noshowpoint : show trailling zeros if necessary
  // force output of decimal point
